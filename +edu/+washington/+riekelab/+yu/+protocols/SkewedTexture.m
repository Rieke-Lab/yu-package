        ...
        function prepareRun(obj)
         ...
         function prepareEpoch(obj, epoch)
            ...
            elseif eventInd == 2
                ...
                obj.imagePatchMatrix = edu.washington.riekelab.yu.utils.getImageTexture(imageMatrix, obj.centerSigma, obj.textureSeed, 1);
            elseif eventInd ==3
                obj.stimulusTag = 'texture';
                obj.imagePatchMatrix = edu.washington.riekelab.yu.utils.getImageTexture(imageMatrix, obj.centerSigma, obj.textureSeed, 0);
            end
