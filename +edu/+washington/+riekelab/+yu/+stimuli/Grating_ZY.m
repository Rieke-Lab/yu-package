classdef Grating_ZY < stage.core.Stimulus
    ...
    properties
        ...
        offset = 0;             % for displaying grating on a background,if background is too high or too low then saturate
    end
    ...
    methods
        ...
        function obj = Grating_ZY(profile, resolution)
    ...
    methods (Access = private)
        ...
        function updateTexture(obj)
            ...
            wave = ((wave + 1) / 2 + obj.offset)* 255; % count in the offset
